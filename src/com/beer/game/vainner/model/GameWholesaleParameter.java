...
public class GameWholesaleParameter implements java.io.Serializable {
	...
	public GameWholesaleParameter() {
	}

	public GameWholesaleParameter(Double price, Double delayCost,
